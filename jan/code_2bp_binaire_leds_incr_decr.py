...
date_dernier_appui2 = time.ticks_ms()
bouton_actif = False
bouton_actif2 = False
...
def bouton_handler2(pin):
    global bouton_actif2
    global date_dernier_appui2
    # on evite les rebonds ...
    if time.ticks_diff(time.ticks_ms(), date_dernier_appui2) > 500: 
        bouton_actif2 = True
        # on reinitialise la variable date_dernier_appui
        date_dernier_appui2 = time.ticks_ms()         
...
bouton2.irq(trigger = machine.Pin.IRQ_FALLING, handler = bouton_handler2)
